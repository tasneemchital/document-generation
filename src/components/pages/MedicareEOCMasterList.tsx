    ...
    <div className="flex flex-col h-full bg-background">
          ...
          <div className="flex items-center gap-2">
            ...
            <Select value={view} onValueChange={setView}>
              ...
              <SelectContent>
                ...
                <SelectItem value="Medicare Handbook">Medicare Handbook</SelectItem>
                <SelectItem value="Medicare Formulary">Medicare Formulary</SelectItem>
                <SelectItem value="Commercial Handbook">Commercial Handbook</SelectItem>
                <SelectItem value="Medicaid Handbook">Medicaid Handbook</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <Select value={instances} onValueChange={setInstances}>
              ...
              <SelectContent>
                ...
                <SelectItem value="Local PPO">Local PPO</SelectItem>
              </SelectContent>
            </Select>
          </div>
      ...
      <div className="flex-shrink-0 border-t border-border bg-card">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="Errors" className="px-6 py-4 max-h-32 overflow-auto">
            <div className="text-sm text-muted-foreground">
              No errors found.
            </div>
          </TabsContent>
          
          <TabsContent value="Activity Log" className="px-6 py-4 max-h-32 overflow-auto">
            <div className="text-sm text-muted-foreground">
              Activity log is empty.
            </div>
          </TabsContent>
          
          <TabsContent value="Journal" className="px-6 py-4 max-h-32 overflow-auto">
            <div className="text-sm text-muted-foreground">
              No journal entries.
            </div>
          </TabsContent>
